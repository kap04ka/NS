#ifndef PARALLELCALCULATION_H
#define PARALLELCALCULATION_H

#pragma once
#include "ICalculation.h"

class ParallelCalculation : public ICalculation { 
public:
    ParallelCalculation() = default;
    ~ParallelCalculation() override = default;
